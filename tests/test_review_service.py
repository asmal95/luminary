...
class TestChunking:
    ...
    def test_chunking_disabled_by_default(self):
        ...
        service.review_file(file_change)
...
class TestParseLLMResponse:
    ...
    def test_parse_json_with_markdown_code_block(self):
        ...
        response = (
            "```json\n"
            + json.dumps([{"file": "test.py", "line": 1, "message": "Comment", "suggestion": None}])
            + "\n```"
        )
    ...
    def test_parse_json_fallback_on_error(self):
        ...
        assert len(comments) == 1
        assert (
            "[Error parsing response]" in comments[0].content
...
class TestExtractSummary:
    ...
    def test_extract_summary_from_json(self):
        ...
        response = json.dumps({"comments": [], "summary": "This is a summary"})
...
class TestLanguageDetection:
    ...
    def test_detect_language_uses_explicit_language(self):
        ...
        _ = FileChange(path="test.py", new_content="code")
